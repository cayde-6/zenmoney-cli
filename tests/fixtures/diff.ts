...
export function fixtureDiff(): ZmDiff {
  ...
  return {
    ...
    tag: [
      { id: 'food', user: 10, title: 'Продукты', parent: null, showIncome: false, showOutcome: true, changed: c },
      { id: 'eat', user: 10, title: 'Еда', parent: null, showIncome: false, showOutcome: true, changed: c },
      { id: 'cafe', user: 10, title: 'Кафе ', parent: 'eat', showIncome: false, showOutcome: true, changed: c },
      { id: 'health', user: 10, title: 'Здоровье', parent: null, showIncome: false, showOutcome: true, changed: c },
      { id: 'dent', user: 10, title: 'Стоматология', parent: 'health', showIncome: false, showOutcome: true, changed: c },
      { id: 'salary', user: 10, title: 'Зарплата', parent: null, showIncome: true, showOutcome: false, changed: c },
      { id: 'subs', user: 10, title: 'Подписки', parent: null, showIncome: false, showOutcome: true, changed: c },
    ],
    merchant: [
